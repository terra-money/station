...
import { Input, TextArea, Submit, FormWarning } from "components/form"
  ...
  return (
    <Form onSubmit={handleSubmit(submit)}>
      <Grid gap={4}>
        <FormWarning>
          {t(
            "Import wallet only accepts private keys generated by exporting another Station wallet. Use the recover wallet feature if you'd like to use a seed phrase."
          )}
        </FormWarning>
      </Grid>
